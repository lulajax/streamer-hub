import { URL } from 'url';
import { CustomSignConfig } from '../../config';
...
/**
 * Custom signer class (Euler compatible).
 */
export class CustomSigner extends EulerStreamApiClient {
    constructor(config: Partial<ClientConfiguration> = {}) {
        super({ ...CustomSignConfig, ...config });
    }
